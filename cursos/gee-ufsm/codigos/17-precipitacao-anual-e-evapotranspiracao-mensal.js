/*****************************************************************************************************
//Unidade 6 - Precipitação Anual e Evapotranspiração Mensal
...
var precipitacao_mensal_acum =  ee.ImageCollection.fromImages(
    ...
    //Defina a variável precipitação
      var precipitation_month = precipitation.filter(ee.Filter.calendarRange(y, y, 'year'))//Filtro de ano
                    ...
                    .clip(area_estudo);//Recortando pela área de estudo
...
print('2 - Informações da Tabela',rainfallYears)
/*****************************Exportando a tabela**********************************/
...
*********************************************************************************/
var years=ee.List.sequence(2000,2020).getInfo(); //Defina a lista de ano
...
var size = precipitacao_mensal_acum_mean.size() //contar quantas imagens tem
print('3 - Quantas imagens existem:', size)
//Criando uma lista
var list = precipitacao_mensal_acum_mean.toList(size)
