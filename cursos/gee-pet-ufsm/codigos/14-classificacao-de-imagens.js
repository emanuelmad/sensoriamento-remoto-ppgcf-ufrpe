...
//Ajustando a acuária conforme o parâmetro do Classificador
...
// Treine um classificador CART com parâmetros padrão.
var trained = ee.Classifier.smileCart({
  maxNodes:null, //O número máximo de nós folha em cada árvore. Se não for especificado, o padrão é sem limite.
  minLeafPopulation:6//Crie apenas nós cujo conjunto de treinamento contenha pelo menos esse número de pontos.
  }).train(training, 'classe', bands);
// Classifique a imagem com as mesmas bandas utilizadas para o treinamento.
...
print("Kappa coefficient", matrizConfucao.kappa())
